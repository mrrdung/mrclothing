...
<div class="pos_page">
                                ...
                                <div class="header_top">
                                   <div class="row align-items-center">
                                        <div class="col-lg-6 col-md-6">
                                           <div class="switcher">
                                                <ul>
                                                    <li class="languages"><a href="#"><img src="assets\img\logo\fontlogo.jpg" alt="">+0965546526</a>  
                                                    </li> 
                                                    <li class="currency"><a href="#">mrdung@gmail.com</i></a>                                                       
                                                    </li> 
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row align-items-center">
                                       <!--logo start-->
                                        <div class="col-lg-3 col-md-3">
                                            <div class="logo">
                                                <a href="index.html"><img src="{{('public/frontend/images/home/logo.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <!--logo end-->
                                                    ...
                                                    <div class="mini_cart">
                                                            @if(Session()->get('cart'))
                                                                ...
                                                                $i++;
                                                                 <div class="cart_item">
                                                                    <div class="cart_img">
                                                                        <a href="{{URL::to('/giohang')}}"><img src="{{asset('/public/upload/product/'.$cart['product_image'])}}" alt=""></a>
                                   ...
                                   <!--sidebar banner-->
                                    <div class="sidebar_widget banner mb-35">
                                        <div class="banner_img mb-35">
                                            <a href="#"><img src="{{('public/frontend/images/home/banner7.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="banner_img">
                                            <a href="#"><img src="{{('public/frontend/images/home/banner8.jpg')}}" alt=""></a>
                                        </div>
                                    </div>
                                    <!--sidebar banner end-->
                                ...
                                <div class="col-lg-9 col-md-12">
                                    ...
                                    <div class="banner_slider slider_1">
                                        <div class="slider_active owl-carousel">
                                            <div class="single_slider" style="background-image: url(public/frontend/images/home/slider_2.png)">
                                            ...
                                            <div class="single_slider" style="background-image: url(public/frontend/images/home/slider_3.png)">
                                                <div class="slider_content">  
                                                    <div class="slider_content_inner">  
	...
	<footer id="footer" style="background-color: #00bba6; color: #fff;"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<h2 style="color: #fff; font-size: 25px; margin-top: 26px;"><span>SHOP</span>MR_DŨNG</h2>
							<p>Thời trang cao cấp, uy tín, chất lượng vận chuyển nhanh chóng!</p>
						</div>
					</div>
					<div class="col-sm-7">
					...
					<div class="col-sm-3">
						<div class="address">
							...
							<p>127TDPTây trinh,P.kỳ trinh, TX.Kỳ anh, TP.Hà tĩnh)</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								<li><a href="#">0938.803.633</a></li>
								<li><a href="#">info@luxury.com</a></li>
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								<li><a href="#">0908.18.12.89</a></li>
								<li><a href="#">cskh@luxuryshop.vn</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-2">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2013 MR_DŨNG.</p>
				</div>
			</div>
		</div>
