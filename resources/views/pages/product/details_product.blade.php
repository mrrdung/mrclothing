                        ...
                        <div class="product_tab fix"> 
                            ...
                            <div class="tab-content produc_tab_c">
                                <div class="tab-pane fade show active" id="p_tab1" role="tabpanel">
                                    <div class="modal_img">
                                        <a href="#"><img src="{{URL::to('public/upload/product/'.$value->product_image)}}" alt=""></a>
                                        <div class="img_icone">
                                            <img src="{{URL::to('public/upload/product/'.$value->product_image)}}" alt="">
                                        </div>
                                        <div class="view_img">
                                            <a class="large_view" href="{{URL::to('public/upload/product/'.$value->product_image)}}"><i class="fa fa-search-plus"></i></a>
                                        </div>    
                                    </div>
                                </div>                                              
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="single_product">
                            <div class="product_thumb">
                                <a href="{{URL::to('/chi-tet-san-pham/'.$value->product_id)}}"><img src="{{URL::to('public/upload/product/'.$value->product_image)}}" alt=""></a> 
